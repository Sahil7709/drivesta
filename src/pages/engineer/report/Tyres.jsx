  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      if (previewFile) {
        ...
        imageUrl = uploaded.files?.[0]?.fileUrl;
        if (!imageUrl) throw new Error("Upload failed");
      } else if (previewUrl) {
        imageUrl = previewUrl.startsWith(ServerUrl.IMAGE_URL)
          ? previewUrl.replace(ServerUrl.IMAGE_URL, "")
          : previewUrl;
      }
            ...
            <React.Fragment key={tyreKey}>
              ...
              {panelEnabled && (
                <div className="flex flex-col w-full relative border-b border-white/20 pb-4 mb-4">
                  <h3 className="text-lg sm:text-xl font-bold mb-4 text-left">
                  ...
                  >
                    <button
                      ...
                      className="w-full bg-gray-800 p-2 rounded-md flex justify-between items-center"
                    >
                        ...
                        {filteredIssues.map((issue) => (
                          ...
                          >
                            <input
                              ...
                              onChange={() =>
                                handleConditionChange(tyreKey, issue)
                              }
                              className="w-4 h-4"
                            />
                            {issue}
